...
# High-end Dark Cyber/AI Startup Theme
# -------------------------------------------------------------
FONT_TITLE = "Helvetica"
FONT_BODY = "Arial"

# Colors
C_BG_DARK       = RGBColor(10, 14, 23)      # #0A0E17 Deep Obsidian
C_CARD_BG       = RGBColor(17, 28, 51)      # #111C33 Slate Navy Card
C_CARD_BORDER   = RGBColor(30, 46, 78)      # #1E2E4E Subtle Card Border
C_CARD_ACTIVE   = RGBColor(22, 38, 70)      # Highlighted Card
...
C_SPOOF_RED     = RGBColor(239, 68, 68)     # #EF4444 Alert / Threat Red
C_SPOOF_BG      = RGBColor(45, 20, 25)      # Red Tinted Dark Card
C_BONAFIDE_GREEN= RGBColor(16, 185, 129)    # #10B981 Verified Green
C_BONAFIDE_BG   = RGBColor(16, 40, 32)      # Green Tinted Dark Card
...
def add_header(slide, title_text, category_text, slide_num):
    ...
    # Category / Tag Pill
    tag_box = slide.shapes.add_textbox(Inches(0.8), Inches(0.55), Inches(7.0), Inches(0.35))
    ...
    # Main Title
    title_box = slide.shapes.add_textbox(Inches(0.8), Inches(0.85), Inches(9.5), Inches(0.75))
    ...
    # Team & Slide Badge (Right Side)
    badge = slide.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(10.533), Inches(0.55), Inches(2.0), Inches(0.55))
    badge.fill.solid()
...
def set_speaker_notes(slide, meaning, script, questions_and_answers):
...
def create_card(slide, left, top, width, height, title="", border_color=C_CARD_BORDER, bg_color=C_CARD_BG):
